                ...
                <?php else: ?>
                    <?php foreach ($created_tasks as $task): ?>
                        <div class="bg-white p-3 rounded-lg shadow">
                            ...
                            <p class="text-xs">总股权数: <?php echo htmlspecialchars(number_format($task['total_shares'])); ?></p>
                            <p class="text-xs">自持股权数: <?php echo htmlspecialchars(number_format($task['own_shares'])); ?></p>
                ...
                <?php else: ?>
                    <?php foreach ($owned_equity as $equity): ?>
                        <div class="bg-white p-3 rounded-lg shadow">
                            ...
                            <p class="text-xs">总股权数: <?php echo htmlspecialchars(number_format($equity['total_shares'])); ?></p>
                            <p class="text-xs">持有股权数: <?php echo htmlspecialchars(number_format($equity['shares_owned'])); ?></p>
