...
<body>
    ...
    <div class="ui-container">
        ...
        <div class="bg-gray-800 text-white p-2 flex justify-between">
            <div>
                <span>Health: <span id="health"><?php echo htmlspecialchars($health); ?></span>/100</span>
                <span class="ml-4">Stamina: <span id="stamina"><?php echo htmlspecialchars($stamina); ?></span>/100</span>
                <span class="ml-4">Actions: <span id="actionCount"><?php echo htmlspecialchars($action_count); ?></span></span>
                <span class="ml-4">Reset in: <span id="resetTimer">00:00</span></span>
            </div>
            <div>
        ...
        <div class="bg-gray-700 text-white p-2 absolute right-0 top-12 h-[calc(100%-3rem)] w-64 overflow-y-auto">
            ...
            <h3 class="text-lg font-bold">Synthesis</h3>
            <div id="synthesis" class="mb-4">
                <div class="flex gap-2 mb-2">
                    ...
                    <div id="synthResult" class="w-10 h-10 flex items-center justify-center">
        ...
        <div class="bg-gray-800 text-white p-2 absolute bottom-0 w-full">
            <h3 class="text-lg font-bold">Ground Items</h3>
