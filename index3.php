...
<head>
    ...
    <style>
        .map-container {
            ...
            overflow: hidden;
            background: #f0f0f0;
            z-index: 10; /* Increased to ensure map is above module background */
            margin-top: 2rem; /* Increased to prevent overlap with UI buttons */
        ...
        .map-svg {
            ...
            width: 800px;
            height: 600px;
            z-index: 1; /* SVG content (image, cities) within container */
        }
        .map-controls {
            position: relative;
